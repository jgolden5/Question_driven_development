  ...
  if [[ "$question" ]]; then
    ...
    if [[ "$answer" ]]; then
      ...
      if (( "$answer_length" > 8 )); then
        ...
        answer="${answer^}" #uppercase first letter of $answer
